...
class WinAppState extends ChangeNotifier {
  ...
  void toggleTheme() { _dark = !_dark; notifyListeners(); }
  void setDark(bool v) { _dark = v; notifyListeners(); }
  void setRole(WinRole r) { _role = r; notifyListeners(); }
}

/// Fournit l'état à tout l'arbre via InheritedNotifier.
class WinAppScope extends InheritedNotifier<WinAppState> {
  const WinAppScope({super.key, required WinAppState super.notifier, required super.child});
