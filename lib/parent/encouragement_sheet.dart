...
class EncouragementSheet extends StatefulWidget {
  ...
  const EncouragementSheet({super.key, required this.child});
  ...
  static Future<void> show(BuildContext context, ApiChild child) =>
      showModalBottomSheet(
        ...
        builder: (_) => EncouragementSheet(child: child),
      );
...
class _EncouragementSheetState extends State<EncouragementSheet> {
  static const _templates = [
    ...
    ('🎯', 'Tu peux le faire, le BAC approche !'),
  ];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Encouragement', style: WinType.archivo(size: 20, color: s.onStrong)),
          const SizedBox(height: 4),
          Text('Pour ${widget.child.firstName}', style: WinType.bodyM(s.onMuted)),
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: selected ? s.primary.withValues(alpha: 0.06) : Colors.transparent,
                ),
                child: Row(children: [
                  ...
                  if (selected) Icon(Icons.check_circle, size: 18, color: s.primary),
                ]),
              ),
            );
          }),
          const SizedBox(height: 12),
          Text('Ou écrire un message personnalisé', style: WinType.labelM(s.onMuted)),
