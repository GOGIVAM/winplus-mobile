...
class _WinAIAlertsScreenState extends State<WinAIAlertsScreen> {
  ...
  Future<void> _load() async {
    ...
    if (mounted) setState(() { _alerts = alerts; _children = children; });
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () { setState(() { _alerts = null; _children = null; }); _load(); },
          ),
        ],
      ),
      body: _alerts == null
      ...
      children: [
        ...
        if (alerts.isEmpty) ...[
          ...
          ...alerts.map((alert) {
            ...
            final child = children.where((c) => c.id == alert.childId).firstOrNull;
            return Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                if (child != null) ...[
                  Row(children: [
                    ...
                    const Spacer(),
                    Text(_formatDate(alert.createdAt), style: WinType.labelS(s.onFaint)),
                  ]),
                ...
                Container(
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Expanded(child: Text(alert.message, style: WinType.bodyS(s.onSurface))),
                  ]),
                ),
                if (child != null) ...[
                  const SizedBox(height: 6),
                  WinButton('Voir l\'activité', small: true,
