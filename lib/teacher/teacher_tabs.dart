  ...
  return Padding(
    ...
    child: Row(children: [
      if (title == null)
        ...
        Text(title, style: WinType.fraunces(size: 22, color: s.onStrong)),
      const Spacer(),
...
Widget _heroStat(String value, String title, String sub) => Builder(
    builder: (_) => Container(
          ...
          child: Row(children: [
            Text(value,
                style: WinType.fraunces(size: 22, color: WinColors.teal400)),
...
TextSpan _accent(String t) => TextSpan(
    text: t,
    style: WinType.fraunces(size: 16, color: WinColors.teal400)
...
class TeacherDashTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final s = WinTheme.of(context);
    final published =
        WinData.profContent.where((c) => c.status == 'Publié').toList();
    ...
    return Column(children: [
      ...
      Expanded(
          child: ListView(
            ...
            WinButton('Publier un nouveau contenu',
        ...
        child: Row(children: [
          ...
          Expanded(
              child: Column(
                ...
                Text(
                    '${c.downloads} téléch.${c.rating > 0 ? '  ·  ${c.rating} ★' : ''}',
...
class _TeacherContentTabState extends State<TeacherContentTab> {
  ...
  Widget build(BuildContext context) {
    final items = _f == 'Tout'
        ? WinData.profContent
        : WinData.profContent.where((c) => c.status == _f).toList();
    return Column(children: [
      ...
      Expanded(
          child: ListView.separated(
              ...
              itemBuilder: (_, i) => _ContentRow(c: items[i]))),
    ]);
  }
}
              ...
              itemBuilder: (_, i) {
                ...
                return WinCard(
                    ...
                    child: Row(children: [
                      ...
                      Text('${st.$3}%',
                          style: WinType.fraunces(size: 16, color: col)),
                    ]));
              })),
    ]);
  }
...
class TeacherSessionsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final s = WinTheme.of(context);
    final sessions = [
      ('math', 'Révision Dérivées  Tle C', '14:00 – 15:30', true),
      ('pc', 'Correction épreuve Physique', '16:30 – 17:30', false)
    ];
    return Column(children: [
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        Container(
                            ...
                            decoration: BoxDecoration(
                                color:
                                    tx[i].$4 ? WinColors.successBg : s.surface2,
                            ...
                            child: Icon(
                                ...
                                size: 16,
                                color:
                                    tx[i].$4 ? WinColors.success : s.onMuted)),
                        const SizedBox(width: 12),
                        Expanded(
                            child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Text('${tx[i].$4 ? '+' : '−'}${fmtXaf(tx[i].$3)}',
                            style: WinType.fraunces(
                                size: 15,
                                color:
                                    tx[i].$4 ? WinColors.success : s.onStrong)),
                      ]),
                    ),
                ])),
          ])),
